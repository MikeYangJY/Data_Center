...
围绕数据中心电力、散热、800VDC架构、项目建设与设备行业建立连续的学习框架。

**先读：[通篇逻辑梳理——从算力密度到设备利润](STUDY_MAP.md)。**

这篇总梳理把七篇笔记与七份原文接成一条研究主线：计算密度如何改变供电与散热，工程选择如何改变设备预算，项目进度如何影响需求兑现，以及供应商如何将机会转化为收入与利润。各节附对应笔记和原文链接，可按问题回查。

## 阅读路线

**01 电力基础 + 02 散热基础 → 03 为什么800VDC → 04 NVIDIA第一版工程架构 → 05 SemiAnalysis迁移模型 → 06 Oxcap六月竞争格局 → 07 Oxcap九月增长与利润率。**
...
| 建设兑现 | [SemiAnalysis容量文章的逻辑](STUDY_MAP.md#delivery) | 如何从项目公告判断真实交付，再追踪设备订单与收入？ |

第一次阅读建议按01→07顺序；已有电力和散热基础，可以从03开始。比较报告观点时，把04的工程需求、05的迁移模型、06—07的产业判断放在一起看。

## 建设与容量：把技术需求接到实际交付

[Stop Saying Half of 2026 US Datacenter Capacity Is Canceled](references/README.md#capacity-pdf)（SemiAnalysis，2026年6月18日）：完整38页按页码分段归档。文章的论证已纳入[总梳理第7节：从规划容量到真正投产](STUDY_MAP.md#delivery)，并在[第8节](STUDY_MAP.md#profit)连接设备订单、收入与利润。
...
进一步串联逻辑：[通篇逻辑梳理](STUDY_MAP.md)。查阅原文附件、网站链接及笔记对应关系：[原文资料目录](SOURCES.md)。
...
- `references/`：对应原文PDF、HTML归档，以及新增的美国数据中心建设与容量报告。
- `assets/`：原笔记中的图示。
